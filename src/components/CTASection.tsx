        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-card border border-border/50 rounded-3xl p-8 md:p-12 shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-lg px-8 py-6 glow-green"
                onClick={() => window.open("https://wa.me/5511999999999?text=Olá! Gostaria de um orçamento para energia solar.", "_blank")}
              >
